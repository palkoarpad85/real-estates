...
class PaginatorHelper extends Helper
{
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'nextDisabled' => '<li class="page-item disabled"><a href="" class="page-link" onclick="return false;">{{text}}</a></li>',
            'prevActive' => '<li class="page-item"><a rel="prev"  class="page-link" href="{{url}}">{{text}}</a></li>',
            'prevDisabled' => '<li class="page-item disabled"><a href="" class="page-link" onclick="return false;">{{text}}</a></li>',
            ...
            'number' => '<li><a href="{{url}}"  class="page-link" >{{text}}</a></li>',
